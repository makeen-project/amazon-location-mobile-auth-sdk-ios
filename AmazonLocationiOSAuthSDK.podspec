Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/makeen-project/amazon-location-mobile-auth-sdk-ios.git', :branch => 'ALMS-204_CocoaPods_Implementation' }

  s.ios.deployment_target = '13.0'

  s.vendored_frameworks = 'frameworks/AmazonLocationiOSAuthSDK.xcframework'
  s.requires_arc = true
